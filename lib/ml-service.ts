...
//   // Transfer request management - FIXED VERSION
...
//   // New method for rejecting transfer requests
//   static async rejectTransferRequest(requestId: string, doctorId: string, notes?: string): Promise<TransferRequest> {
//     try {
//       return await this.updateTransferRequest(requestId, {
//         status: "rejected",
//         doctor_id: doctorId,
//         notes: notes || "Transfer request rejected by doctor",
//         updated_at: new Date().toISOString()
//       })
//     } catch (error) {
...
//   // New method for approving transfer requests
...
//         notes: notes || "Transfer approved by doctor",
//         updated_at: new Date().toISOString()
//       })
//     } catch (error) {
